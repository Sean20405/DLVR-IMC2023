...
args = {
    ...
    "pixsfm_script_path": "./run_pixsfm.py",
...
def main(args):
    ...
    # DELETE SKIP SCENES
    if args.skip_scenes is not None:
        for dataset in data_dict:
            for scene in args.skip_scenes:
                if scene in data_dict[dataset]:
                    logging.info(f"Removing {dataset} - {scene} from data_dict")
                    del data_dict[dataset][scene]
